...
请从[官方文档](https://www.algolia.com/doc/tools/crawler/netlify-plugin/quick-start/)开始。
...
从Algolia的[官方文档](https://community.algolia.com/jekyll-algolia/getting-started.html)开始。
