...
> (All-or-Nothing Thesis, **ANT**)规则R*R*与原则P*P*在逻辑上是不同的，就特定议题i而言，只能有一个*R*，当发生包含i*i*的具体案件时，必须适用*R*且只能提出一个要求*d*；就i*i*而言，可能有不止一个*P*，且当发生包含i*i*的具体案件时，不是必须适用*P*，且若适用，不必只提出一个要求*d*。
